...
int main(void)
{
	...
	pid_t p;
	proc_fn_t *proc_fn;
    printf("Please give value for K : ");
	if (scanf("%d",&K) < 0) {
		perror("scanf : could not read input");
		exit(1);
	}
